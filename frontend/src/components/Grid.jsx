  ...
  return (
    <section className="py-[65px] text-white px-4">
      <h2 className="text-center lg:text-3xl md:text-2xl text-xl font-semibold font-montserrat max-w-[986px] mx-auto">
        Empower your Web3 CI/CD journey with Oswald. Automate workflows, secure file integrity, and deliver with confidence. Oswald’s command-driven approach is your ultimate tool for secure and efficient deployments
      </h2>
